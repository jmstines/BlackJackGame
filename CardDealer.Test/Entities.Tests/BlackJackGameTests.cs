...
namespace Entities.Tests
{
	...
	public class BlackJackGameTests
	{
		...
		public void Init()
		{
			DealerNamedData = new BlackJackPlayer(new AvitarDto() { id = "1234ck64-f9d8", userName = "Data" }, HandIdentifierProvider, 1);
		}
		...
		public void NewGame_NullDeck_PlayerArgumentNullException()
		{
			...
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = "8625cf04-b7e2", userName = playerName }, HandIdentifierProvider, 1));
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = "8625cf04-b7e2", userName = playerName }, HandIdentifierProvider, 1));
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = "8625cf04-b7e2", userName = playerName }, HandIdentifierProvider, 1));
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = "8625cf04-b7e2", userName = playerName }, HandIdentifierProvider, 1));

			Assert.Throws<InvalidOperationException>(() => game.AddPlayer(
				new BlackJackPlayer(new AvitarDto() { id = "8625cf04-b7e2", userName = playerName }, HandIdentifierProvider, 1)));
		}
		...
		public void NewGameMax3Players_Add4thPlayer_ThrowsInvalidOperation()
		{
			...
			Assert.Throws<InvalidOperationException>(() => game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = "8625cf04-b7e2", userName = playerName }, HandIdentifierProvider, 1)));
		...
		public void NewGame_SinglePlayerAndDealer_CurrentPlayerIndexZero()
		{
			...
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = "8625cf04-b7e2", userName = playerName }, HandIdentifierProvider, 1));
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = "8625cf04-b7e2", userName = playerName2 }, HandIdentifierProvider, 1));
		...
		public void Deal_NullDeck_ThrowArgumentNullException()
		{
			...
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = player2Id, userName = playerName }, HandIdentifierProvider, 1));
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = player2Id, userName = playerName2 }, HandIdentifierProvider, 1));
		...
		public void Deal_ThenAddNewPlayer_ThrowInvalidOperationException()
		{
			...
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = playerId, userName = playerName }, HandIdentifierProvider, 1));
			game.AddPlayer(new BlackJackPlayer(new AvitarDto() { id = player2Id, userName = playerName2 }, HandIdentifierProvider, 1));
