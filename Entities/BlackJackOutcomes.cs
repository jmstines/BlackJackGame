...
namespace Entities
{
	...
	public class BlackJackOutcomes
	{
		...
		//private bool HasBlackjack(BlackJackPlayer player) => player.Hands.PointValue == BlackJackConstants.BlackJack;
		//private bool BustHand(BlackJackPlayer player) => player.Hands.PointValue > BlackJackConstants.BlackJack;
		//private bool PlayerPointsLessThanDealer(BlackJackPlayer player) => player.Hands.PointValue < Game.Players.Last().Hands.PointValue;
		//private bool PlayerPointsEqualsDealer(BlackJackPlayer player) => player.Hands.PointValue == Game.Players.Last().Hands.PointValue;
	}
}
